...
: ${AMENT_CURRENT_PREFIX:="/media/psf/Home/Desktop/machine/src/install/itof"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/itof/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/itof/environment/path.sh"
